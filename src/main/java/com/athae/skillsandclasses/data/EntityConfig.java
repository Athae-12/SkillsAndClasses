...
public class EntityConfig implements JsonRegistry<EntityConfig>, IAutoGson<EntityConfig> {
    ...
    @Override
    public skillsandclassesRegistryType getExileRegistryType() {
        return skillsandclassesRegistryType.ENTITY_CONFIGS;
    }
