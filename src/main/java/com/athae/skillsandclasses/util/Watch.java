...
public class Watch {
    ...
    public void print(String str) {
        ...
        if (time >= min) {
            skillsandclassesLog.get().debug(str + "Action took: " + time + " " + unit.name().toLowerCase(Locale.ROOT));
    ...
    public void print() {
        ...
        time = stop.getTime(unit);
        if (time >= min) {
            skillsandclassesLog.get().debug("Action took: " + time + " " + unit.name().toLowerCase(Locale.ROOT));
